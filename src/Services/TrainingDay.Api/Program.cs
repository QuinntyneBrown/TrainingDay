...
try
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "TrainingDay");
    ...
    {
        var context = scope.ServiceProvider.GetRequiredService<TrainingDayDbContext>();
        ...
        {
            context.Database.ExecuteSql($"DROP SCHEMA [TrainingDay]");

            context.Database.ExecuteSql($"DELETE from __EFMigrationsHistory where MigrationId like '%_TrainingDay_%';");
        }
